 ...
 * Batch 40–44 (500 từ khóa ngắn tiếp theo): #3447–#3946.
 * Batch 45–49 (500 từ khóa ngắn tiếp theo): #3947–#4446.
...
export { shortKeywordCalendarBatch40 } from "./short-keyword-calendar-batch40";
export { shortKeywordCalendarBatch41 } from "./short-keyword-calendar-batch41";
export { shortKeywordCalendarBatch42 } from "./short-keyword-calendar-batch42";
export { shortKeywordCalendarBatch43 } from "./short-keyword-calendar-batch43";
export { shortKeywordCalendarBatch44 } from "./short-keyword-calendar-batch44";
export { shortKeywordCalendarBatch45 } from "./short-keyword-calendar-batch45";
export { shortKeywordCalendarBatch46 } from "./short-keyword-calendar-batch46";
export { shortKeywordCalendarBatch47 } from "./short-keyword-calendar-batch47";
export { shortKeywordCalendarBatch48 } from "./short-keyword-calendar-batch48";
export { shortKeywordCalendarBatch49 } from "./short-keyword-calendar-batch49";
export { shortKeywordCalendarBatch50 } from "./short-keyword-calendar-batch50";
export { shortKeywordCalendarBatch51 } from "./short-keyword-calendar-batch51";
export { shortKeywordCalendarBatch52 } from "./short-keyword-calendar-batch52";
export { shortKeywordCalendarBatch53 } from "./short-keyword-calendar-batch53";
export { shortKeywordCalendarBatch54 } from "./short-keyword-calendar-batch54";
export { shortKeywordCalendarBatch55 } from "./short-keyword-calendar-batch55";
export { shortKeywordCalendarBatch56 } from "./short-keyword-calendar-batch56";
export { shortKeywordCalendarBatch57 } from "./short-keyword-calendar-batch57";
export { shortKeywordCalendarBatch58 } from "./short-keyword-calendar-batch58";
export { shortKeywordCalendarBatch59 } from "./short-keyword-calendar-batch59";
export { shortKeywordCalendarBatch60 } from "./short-keyword-calendar-batch60";
export { shortKeywordCalendarBatch61 } from "./short-keyword-calendar-batch61";
