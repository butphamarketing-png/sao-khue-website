...
const SLUG = "xay-dung-nha-phu-yen";
const SK_IMG_1 = slugImage(SLUG, 0);
const SK_IMG_2 = slugImage(SLUG, 1);
const SK_IMG_3 = slugImage(SLUG, 2);

export const xayDungNhaPhuYen = {
  title: "Xây Dựng Nhà Uy Tín Tại Phú Yên — Trọn Gói Từ A Đến Z",
  excerpt:
    "Dịch vụ xây dựng nhà Phú Yên chuyên nghiệp: nhà phố, biệt thự ven biển, thi công trọn gói. Sao Khuê khảo sát miễn phí, bảo hành 10 năm — 0909 075 668.",
  metaTitle: "Xây Dựng Nhà Phú Yên Uy Tín | Trọn Gói | Sao Khuê",
  metaDescription:
    "Xây dựng nhà Phú Yên: thiết kế, thi công nhà phố, biệt thự Tuy Hòa, Sông Cầu. Báo giá minh bạch, bảo hành kết cấu 10 năm. Gọi 0909 075 668.",
  metaKeywords:
    "xây dựng nhà Phú Yên, xây nhà trọn gói Phú Yên, thi công nhà phố Phú Yên, công ty xây dựng Phú Yên, xây nhà Tuy Hòa, kiến trúc sao khuê",
  imageAlt: "xây dựng nhà Phú Yên",
  imageCaption: "xây dựng nhà Phú Yên — công trình Sao Khuê",
  content: `
<h2>Xây dựng nhà Phú Yên — Giải pháp trọn gói cho gia đình và đầu tư ven biển</h2>
