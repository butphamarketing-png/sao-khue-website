...
export const thietKeNhaPhoHienDaiTphcm = {
  ...
  excerpt:
    "Thiết kế nhà phố TP.HCM chuyên nghiệp: phong cách hiện đại, mặt bằng tối ưu, phối cảnh 3D. Sao Khuê tư vấn miễn phí — 0909 075 668.",
  metaTitle: "Thiết Kế Nhà Phố TP.HCM | Phong Cách Hiện Đại | Sao Khuê",
  metaDescription:
    "Dịch vụ thiết kế nhà phố TP.HCM: hiện đại, ánh sáng, công năng trên lô hẹp. Hồ sơ 2D/3D, xin phép. Khảo sát miễn phí — 0909 075 668.",
  metaKeywords:
    "thiết kế nhà phố TP.HCM, thiết kế nhà phố hiện đại, mẫu nhà phố tphcm, thi công nhà phố tphcm, kiến trúc sao khuê",
  imageAlt: "thiết kế nhà phố tphcm",
  imageCaption: "thiết kế nhà phố tphcm",
  content: `
<h2>Thiết kế nhà phố TP.HCM — Nền tảng cho công trình bền vững</h2>
...
<p><strong>Kiến Trúc Sao Khuê</strong> — <strong>Thiết kế nhà phố TP.HCM</strong> chuẩn kỹ thuật, thẩm mỹ hiện đại, sẵn sàng đồng hành từ bản vẽ đến công trình hoàn thiện.</p>
`.trim(),
};
