...
export const thietKeThiCongNhaPhoDongNai = {
  ...
  excerpt:
    "Thi công nhà phố Đồng Nai chuyên nghiệp: thiết kế hiện đại, thi công trọn gói tại Biên Hòa, Long Thành, Nhơn Trạch. Báo giá minh bạch — 0909 075 668.",
  metaTitle: "Thi Công Nhà Phố Đồng Nai | Sao Khuê",
  metaDescription:
    "Thiết kế và thi công nhà phố hiện đại Đồng Nai. Sao Khuê: mặt bằng 3D, trọn gói, bảo hành kết cấu 10 năm. Khảo sát miễn phí — 0909 075 668.",
  metaKeywords:
    "thi công nhà phố Đồng Nai, thiết kế nhà phố Đồng Nai, nhà phố hiện đại Đồng Nai, xây nhà phố Đồng Nai, kiến trúc sao khuê",
  content: `
<h2>Thi công nhà phố Đồng Nai — Thiết kế &amp; thi công một đơn vị</h2>
...
<p><strong>Kiến Trúc Sao Khuê</strong> — Thiết kế chuẩn, thi công nhà phố Đồng Nai uy tín, bàn giao đúng cam kết.</p>
`.trim(),
};
