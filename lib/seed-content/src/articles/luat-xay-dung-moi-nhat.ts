/** Nội dung bài viết SEO — slug: luat-xay-dung-moi-nhat */
export const luatXayDungMoiNhat = {
  title: "Luật Xây Dựng 2026 — Điểm Chủ Nhà Cần Lưu Ý",
  excerpt:
  ...
  content: `
<h2>Luật Xây dựng — Chủ nhà cần nắm trước khi khởi công</h2>
