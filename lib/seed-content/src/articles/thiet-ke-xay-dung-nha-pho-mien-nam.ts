...
export const thietKeXayDungNhaPhoMienNam = {
  ...
  metaTitle: "Thiết Kế Xây Dựng Nhà Phố Miền Nam | TP.HCM, Bình Dương, Đồng Nai | Sao Khuê",
  metaDescription:
  ...
  imageAlt: "thiết kế xây dựng nhà phố miền Nam",
  imageCaption: "thiết kế xây dựng nhà phố miền Nam",
  content: `
