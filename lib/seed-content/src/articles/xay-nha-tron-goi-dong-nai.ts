...
export const xayNhaTronGoiDongNai = {
  ...
  excerpt:
    "Xây nhà trọn gói Đồng Nai giá tốt: báo giá minh bạch, khảo sát miễn phí tại Biên Hòa, Long Thành, Nhơn Trạch. Bảo hành kết cấu 10 năm — 0909 075 668.",
  metaTitle: "Xây Nhà Trọn Gói Đồng Nai Giá Tốt | Sao Khuê",
  metaDescription:
    "Xây nhà trọn gói Đồng Nai giá tốt, chìa khóa trao tay. Đơn giá 4,85–6,7 triệu/m², miễn phí thiết kế 2D/3D. Sao Khuê thi công uy tín — 0909 075 668.",
  metaKeywords:
    "xây nhà trọn gói Đồng Nai, xây nhà trọn gói giá rẻ Đồng Nai, nhà thầu xây dựng Đồng Nai, xây nhà chìa khóa trao tay, kiến trúc sao khuê",
  content: `
<h2>Xây nhà trọn gói Đồng Nai giá tốt — Chìa khóa trao tay từ Sao Khuê</h2>
...
<p><strong>Kiến Trúc Sao Khuê</strong> — Xây nhà trọn gói Đồng Nai giá tốt, chất lượng chuẩn, bàn giao đúng cam kết.</p>
`.trim(),
};
