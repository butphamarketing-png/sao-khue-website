/** Nội dung bài viết SEO — slug: sua-chua-nha-tphcm */
export const suaChuaNhaTphcm = {
  title: "Sửa Chữa Nhà TP.HCM — Chống Thấm, Sơn, Cải Tạo Nhanh",
  excerpt:
  ...
  content: `
<h2>Sửa chữa nhà TP.HCM — Xử lý nhanh các hư hỏng thường gặp</h2>
