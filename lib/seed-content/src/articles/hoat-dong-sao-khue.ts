/** Nội dung bài viết SEO — slug: hoat-dong-sao-khue */
export const hoatDongSaoKhue = {
  title: "Hoạt Động Sao Khuê — Đồng Hành Cộng Đồng & Nghề Xây Dựng",
  excerpt:
    "Các hoạt động Sao Khuê: đào tạo nghề, an toàn lao động, chia sẻ kinh nghiệm xây nhà và tham gia cộng đồng tại TP.HCM.",
  metaTitle: "Hoạt Động Sao Khuê — Cộng Đồng & Đào Tạo",
  metaDescription:
    "Hoạt động Công ty Kiến Trúc Sao Khuê: đào tạo thợ, an toàn công trình, chia sẻ kiến thức xây dựng. Theo dõi fanpage và tin tức.",
  metaKeywords:
    "hoạt động sao khuê, công ty xây dựng tphcm, kiến trúc sao khuê, tin tức xây dựng",
  content: `
<h2>Hoạt động Sao Khuê — Xây dựng bền vững, gắn kết cộng đồng</h2>
