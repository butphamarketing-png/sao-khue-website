...
export const kienTrucSaoKhueDonViUyTin = {
  ...
  metaTitle: "Kiến Trúc Sao Khuê | Thiết Kế Xây Dựng Nhà Phố Uy Tín TP.HCM",
  metaDescription:
  ...
  imageAlt: "Kiến Trúc Sao Khuê đơn vị uy tín",
  imageCaption: "Kiến Trúc Sao Khuê đơn vị uy tín",
  content: `
