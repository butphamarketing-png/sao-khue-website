/** Nội dung bài viết SEO — slug: cong-ty-xay-dung-nha-pho-uy-tin-tphcm */
export const congTyXayDungNhaPhoUyTinTphcm = {
  title: "Công Ty Xây Dựng Nhà Phố Uy Tín Tại TP.HCM",
  excerpt:
    "Công ty xây dựng nhà phố TP.HCM uy tín: thiết kế, thi công trọn gói, báo giá minh bạch, bảo hành kết cấu 10 năm. Tư vấn khảo sát miễn phí — Hotline 0909 085 668.",
  metaTitle: "Công Ty Xây Dựng Nhà Phố Uy Tín TP.HCM | Sao Khuê",
  metaDescription:
    "Công ty xây dựng nhà phố TP.HCM uy tín: thi công trọn gói, báo giá 4,85–6,7 triệu/m², bảo hành kết cấu 10 năm. Khảo sát miễn phí — 0909 085 668.",
  metaKeywords:
    "xây dựng nhà phố tphcm, công ty xây dựng nhà phố, xây nhà phố uy tín, nhà thầu xây nhà phố, xây nhà trọn gói tphcm, kiến trúc sao khuê",
...
<p><strong>Kiến Trúc Sao Khuê</strong> — Uy tín từ thiết kế đến thi công, <strong>xây dựng nhà phố TP.HCM</strong> đúng tiến độ, đúng cam kết, xây dựng tổ ấm bền vững cho gia đình bạn.</p>`,
};
