...
export const xayNhaPhoThuanAn = {
  ...
  excerpt:
    "Case study nhà phố Thuận An: lô 5x16m, 4 tầng hiện đại, thi công trọn gói Sao Khuê — bàn giao đúng tiến độ, bảo hành kết cấu 10 năm.",
  metaTitle: "Xây Nhà Phố Thuận An Bình Dương | Sao Khuê",
  metaDescription:
    "Công trình xây nhà phố Thuận An, Bình Dương: 4 tầng, thi công trọn gói, báo giá minh bạch. Tham khảo mẫu Sao Khuê — 0909 075 668.",
  metaKeywords:
    "xây nhà phố thuận an, xây nhà bình dương, công trình nhà phố, xây nhà trọn gói bình dương, sao khuê",
  content: `
<h2>Công trình xây nhà phố tại Thuận An, Bình Dương</h2>
