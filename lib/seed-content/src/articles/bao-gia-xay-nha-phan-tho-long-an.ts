...
export const baoGiaXayNhaPhanThoLongAn = {
  ...
  metaTitle: "Báo Giá Xây Nhà Phần Thô Long An 2026 | Chi Tiết | Sao Khuê",
  metaDescription:
  ...
  imageAlt: "báo giá xây nhà phần thô Long An",
  imageCaption: "báo giá xây nhà phần thô Long An",
  content: `
