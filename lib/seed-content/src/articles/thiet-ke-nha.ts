/** Nội dung bài viết SEO — slug: thiet-ke-nha */
export const thietKeNha = {
  title: "Thiết Kế Nhà Ở TP.HCM — Nhà Phố, Biệt Thự 2D/3D",
  excerpt:
  ...
  content: `
<h2>Thiết kế nhà ở — Bước đầu quyết định chất lượng công trình</h2>
