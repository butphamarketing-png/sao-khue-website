...
const SLUG = "sua-chua-cai-tao-nha-tphcm";
const SK_IMG_1 = slugImage(SLUG, 0);
const SK_IMG_2 = slugImage(SLUG, 1);
const SK_IMG_3 = slugImage(SLUG, 2);

export const suaChuaCaiTaoNhaTphcm = {
  title: "Sửa Chữa Cải Tạo Nhà TP.HCM — Trọn Gói Theo Quận Huyện",
  excerpt:
    "Dịch vụ sửa chữa cải tạo nhà TP.HCM tại 22 quận và 5 huyện: chống thấm, gia cố, nâng tầng, sửa nhà cũ. Sao Khuê khảo sát miễn phí — 0909 075 668.",
  metaTitle: "Sửa Chữa Cải Tạo Nhà TP.HCM | Trọn Gói | Sao Khuê",
  metaDescription:
    "Sửa chữa cải tạo nhà TP.HCM uy tín: Quận 1–12, Thủ Đức, Bình Thạnh, Gò Vấp, Bình Chánh… Báo giá minh bạch, bảo hành hạng mục. Gọi 0909 075 668.",
  metaKeywords:
    "sửa chữa cải tạo nhà TP.HCM, sửa nhà trọn gói tphcm, cải tạo nhà cũ tphcm, sửa chữa nhà theo quận, công ty sửa nhà tphcm, kiến trúc sao khuê",
  imageAlt: "sửa chữa cải tạo nhà TP.HCM",
  imageCaption: "sửa chữa cải tạo nhà TP.HCM — công trình Sao Khuê",
  content: `
<h2>Sửa chữa cải tạo nhà TP.HCM — Dịch vụ trọn gói theo từng quận, huyện</h2>
