...
const SLUG = "xay-nha-dep-dak-lak";
const SK_IMG_1 = slugImage(SLUG, 0);
const SK_IMG_2 = slugImage(SLUG, 1);
const SK_IMG_3 = slugImage(SLUG, 2);

export const xayNhaDepDakLak = {
  title: "Xây Nhà Đẹp Tại Đắk Lắk — Thiết Kế & Thi Công Trọn Gói",
  excerpt:
    "Xây nhà đẹp Đắk Lắk: nhà phố, biệt thự Buôn Ma Thuột phong cách hiện đại. Sao Khuê thiết kế 3D + thi công trọn gói, bảo hành 10 năm — 0909 075 668.",
  metaTitle: "Xây Nhà Đẹp Đắk Lắk | Thiết Kế & Thi Công | Sao Khuê",
  metaDescription:
    "Dịch vụ xây nhà đẹp Đắk Lắk: mặt tiền ấn tượng, công năng tối ưu, hoàn thiện cao cấp. Báo giá minh bạch, bảo hành kết cấu 10 năm. Gọi 0909 075 668.",
  metaKeywords:
    "xây nhà đẹp Đắk Lắk, thiết kế nhà đẹp Đắk Lắk, xây nhà trọn gói Đắk Lắk, nhà phố Buôn Ma Thuột, kiến trúc sao khuê",
  imageAlt: "xây nhà đẹp Đắk Lắk",
  imageCaption: "xây nhà đẹp Đắk Lắk — thi công Sao Khuê",
  content: `
<h2>Xây nhà đẹp Đắk Lắk — Khi thẩm mỹ đi cùng chất lượng thi công</h2>
