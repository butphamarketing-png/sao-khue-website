/** Nội dung bài viết SEO — slug: xay-nha-tron-goi-binh-duong */
export const xayNhaTronGoiBinhDuong = {
  title: "Xây Nhà Trọn Gói Chuyên Nghiệp Tại Bình Dương",
  excerpt:
    "Xây nhà trọn gói Bình Dương: khảo sát miễn phí, báo giá minh bạch, thi công chuyên nghiệp tại Thủ Dầu Một, Thuận An, Dĩ An. Bảo hành kết cấu 10 năm — 0909 075 668.",
  metaTitle: "Xây Nhà Trọn Gói Bình Dương | Sao Khuê",
  metaDescription:
    "Dịch vụ xây nhà trọn gói Bình Dương chìa khóa trao tay. Đơn giá tham khảo 4,85–6,7 triệu/m², không phát sinh, miễn phí thiết kế 2D/3D. Tư vấn 0909 075 668.",
  metaKeywords:
    "xây nhà trọn gói Bình Dương, xây nhà trọn gói giá rẻ Bình Dương, nhà thầu xây dựng Bình Dương, xây nhà chìa khóa trao tay, kiến trúc sao khuê",
  content: `
<h2>Xây nhà trọn gói Bình Dương — Giải pháp chìa khóa trao tay</h2>
...
<p><strong>Sao Khuê</strong> — Đồng hành xây dựng tổ ấm tại Bình Dương: đúng tiến độ, đúng cam kết, chuyên nghiệp từ khảo sát đến bàn giao.</p>
`.trim(),
};
