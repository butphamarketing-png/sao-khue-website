...
export const mauNhaPho2TangBinhDuong = {
  ...
  excerpt:
    "Tổng hợp mẫu nhà phố 2 tầng Bình Dương: kích thước lô đất phổ biến, phong cách hiện đại, công năng và chi phí tham khảo. Tư vấn thiết kế & thi công — 0909 075 668.",
  metaTitle: "Nhà Phố 2 Tầng Bình Dương Đẹp | Sao Khuê",
  metaDescription:
...
<p><strong>Kiến Trúc Sao Khuê</strong> — Thiết kế mẫu chuẩn, thi công uy tín, đồng hành xây tổ ấm tại Bình Dương.</p>
`.trim(),
};
