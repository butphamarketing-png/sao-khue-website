import {
  ...
  shortKeywordBatch18ArticlesBySlug,
  shortKeywordBatch18Slugs,
  shortKeywordBatch19ArticlesBySlug,
  shortKeywordBatch19Slugs,
  shortKeywordBatch20ArticlesBySlug,
  shortKeywordBatch20Slugs,
  shortKeywordBatch21ArticlesBySlug,
  shortKeywordBatch21Slugs,
  shortKeywordBatch22ArticlesBySlug,
  shortKeywordBatch22Slugs,
  shortKeywordBatch23ArticlesBySlug,
  shortKeywordBatch23Slugs,
  shortKeywordBatch24ArticlesBySlug,
  shortKeywordBatch24Slugs,
  shortKeywordBatch25ArticlesBySlug,
  shortKeywordBatch25Slugs,
  shortKeywordBatch26ArticlesBySlug,
  shortKeywordBatch26Slugs,
  shortKeywordBatch27ArticlesBySlug,
  shortKeywordBatch27Slugs,
  shortKeywordBatch28ArticlesBySlug,
  shortKeywordBatch28Slugs,
  shortKeywordBatch29ArticlesBySlug,
  shortKeywordBatch29Slugs,
  shortKeywordBatch30ArticlesBySlug,
  shortKeywordBatch30Slugs,
  shortKeywordBatch31ArticlesBySlug,
  shortKeywordBatch31Slugs,
  shortKeywordBatch32ArticlesBySlug,
  shortKeywordBatch32Slugs,
  shortKeywordBatch33ArticlesBySlug,
  shortKeywordBatch33Slugs,
  shortKeywordBatch34ArticlesBySlug,
  shortKeywordBatch34Slugs,
  shortKeywordBatch35ArticlesBySlug,
  shortKeywordBatch35Slugs,
  shortKeywordBatch36ArticlesBySlug,
  shortKeywordBatch36Slugs,
  shortKeywordBatch37ArticlesBySlug,
  shortKeywordBatch37Slugs,
  shortKeywordBatch38ArticlesBySlug,
  ...
  shortKeywordBatch45ArticlesBySlug,
  shortKeywordBatch45Slugs,
  shortKeywordBatch46ArticlesBySlug,
  shortKeywordBatch46Slugs,
  shortKeywordBatch47ArticlesBySlug,
  shortKeywordBatch47Slugs,
  shortKeywordBatch48ArticlesBySlug,
  shortKeywordBatch48Slugs,
  shortKeywordBatch49ArticlesBySlug,
  shortKeywordBatch49Slugs,
  shortKeywordBatch50ArticlesBySlug,
  shortKeywordBatch50Slugs,
  shortKeywordBatch51ArticlesBySlug,
  shortKeywordBatch51Slugs,
  shortKeywordBatch52ArticlesBySlug,
  shortKeywordBatch52Slugs,
  shortKeywordBatch53ArticlesBySlug,
  shortKeywordBatch53Slugs,
  shortKeywordBatch54ArticlesBySlug,
  shortKeywordBatch54Slugs,
  shortKeywordBatch55ArticlesBySlug,
  shortKeywordBatch55Slugs,
  shortKeywordBatch56ArticlesBySlug,
  shortKeywordBatch56Slugs,
  shortKeywordBatch57ArticlesBySlug,
  shortKeywordBatch57Slugs,
  shortKeywordBatch58ArticlesBySlug,
  shortKeywordBatch58Slugs,
  shortKeywordBatch59ArticlesBySlug,
  shortKeywordBatch59Slugs,
  shortKeywordBatch60ArticlesBySlug,
  shortKeywordBatch60Slugs,
  shortKeywordBatch61ArticlesBySlug,
  shortKeywordBatch61Slugs,
  shortKeywordBatch62ArticlesBySlug,
  shortKeywordBatch62Slugs,
  shortKeywordBatch63ArticlesBySlug,
...
const seedPostsRaw: SeedPost[] = [
  ...
  ...shortKeywordBatch15Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch15ArticlesBySlug[slug]!),
  ),
  ...
  ...shortKeywordBatch18Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch18ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch19Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch19ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch20Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch20ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch21Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch21ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch22Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch22ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch23Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch23ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch24Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch24ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch25Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch25ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch26Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch26ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch27Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch27ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch28Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch28ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch29Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch29ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch30Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch30ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch31Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch31ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch32Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch32ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch33Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch33ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch34Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch34ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch35Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch35ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch36Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch36ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch37Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch37ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch38Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch38ArticlesBySlug[slug]!),
  ),
  ...
  ...shortKeywordBatch45Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch45ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch46Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch46ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch47Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch47ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch48Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch48ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch49Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch49ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch50Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch50ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch51Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch51ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch52Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch52ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch53Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch53ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch54Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch54ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch55Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch55ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch56Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch56ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch57Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch57ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch58Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch58ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch59Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch59ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch60Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch60ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch61Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch61ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch62Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch62ArticlesBySlug[slug]!),
  ),
  ...shortKeywordBatch63Slugs.map((slug) =>
    seoPost(slug, "tin-tuc", featuredImageForSlug(slug), shortKeywordBatch63ArticlesBySlug[slug]!),
  ),
