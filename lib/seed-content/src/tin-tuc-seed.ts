...
const ARTICLE_BY_SLUG: Record<string, SeoArticle> = {
  ...
  "thiet-ke-nha-dep-dak-lak": thietKeNhaDepDakLak,
  "thiet-ke-nha-dep-tphcm": thietKeNhaDepTphcm,
...
export const TIN_TUC_SEED_ENTRIES: TinTucSeedEntry[] = [
  ...
  { slug: "thiet-ke-nha-dep-dong-nai", image: featuredImageForSlug("thiet-ke-nha-dep-dong-nai"), article: thietKeNhaDepDongNai },
  { slug: "thiet-ke-nha-dep-long-an", image: featuredImageForSlug("thiet-ke-nha-dep-long-an"), article: thietKeNhaDepLongAn },
  { slug: "thiet-ke-nha-dep-binh-duong", image: featuredImageForSlug("thiet-ke-nha-dep-binh-duong"), article: thietKeNhaDepBinhDuong },
  { slug: "thiet-ke-nha-dep-dak-lak", image: featuredImageForSlug("thiet-ke-nha-dep-dak-lak"), article: thietKeNhaDepDakLak },
  { slug: "thiet-ke-nha-dep-tphcm", image: featuredImageForSlug("thiet-ke-nha-dep-tphcm"), article: thietKeNhaDepTphcm },
  ...TIN_TUC_BATCH.map((b) => ({
    slug: b.slug,
    image: b.image,
