...
const projects = [
  { id: 1, title: "Biệt Thự Hiện Đại Chị Lan - Q.2", image: "/images/project_1.jpg" },
  { id: 2, title: "Nhà Phố Tân Cổ Điển Anh Tuấn - Q.7", image: "/images/project_2.jpg" },
  { id: 3, title: "Nhà Phố 3 Tầng Anh Hùng - Bình Thạnh", image: "/images/project_3.jpg" },
  { id: 4, title: "Nội Thất Căn Hộ Vinhomes Chị Mai", image: "/images/interior_2.jpg" },
  { id: 5, title: "Biệt Thự Vườn Cô Hoa - Đồng Nai", image: "/images/project_4.jpg" },
  { id: 6, title: "Thiết Kế Nhà Phố Kết Hợp Kinh Doanh", image: "/images/interior_3.jpg" },
  { id: 7, title: "Nhà Phố Hiện Đại 4 Tầng - Gò Vấp", image: "/images/interior_4.jpg" },
  { id: 8, title: "Biệt Thự Nghỉ Dưỡng Chú Ba - Vũng Tàu", image: "/images/project-1.png" },
];
    ...
    <section id="du-an" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <Link href="/du-an" className="inline-flex items-center justify-center px-8 py-3 border-2 border-primary text-primary font-bold hover:bg-primary hover:text-white transition-colors rounded-sm uppercase tracking-wide">
            Xem Thêm Dự Án
          </Link>
        </div>
      </div>
