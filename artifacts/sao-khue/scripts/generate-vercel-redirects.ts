 ...
 * Chạy trong `pnpm build`; cập nhật middleware.ts + xóa redirects khỏi vercel.json.
 *
...
const middlewareFile = join(apiServerDir, "middleware.ts");
...
console.log(`[redirects] ${bulk.length} rules → middleware.ts (Hobby Edge Middleware)`);
