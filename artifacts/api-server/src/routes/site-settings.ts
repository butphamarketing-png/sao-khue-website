...
const SettingsInput = z.object({
  ...
  facebookUrl2: z.string().default(""),
  facebookLabel1: z.string().default(""),
  facebookLabel2: z.string().default(""),
  youtubeUrl: z.string().default(""),
  instagramUrl: z.string().default(""),
  zaloPhone: z.string().default(""),
  messengerUrl: z.string().default(""),
  messengerUrl2: z.string().default(""),
  messengerLabel1: z.string().default(""),
  messengerLabel2: z.string().default(""),
